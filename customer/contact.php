...
<div class="grid md:grid-cols-3 items-start gap-4 max-md:gap-12 max-w-6xl mx-auto py-6 bg-white font-[sans-serif]">
        ...
        <div class="space-y-8 mt-8">
          <div class="flex">
            ...
            <div class="ml-4">
              ...
              <p class="text-sm mt-4 text-black">linin999.ygn@gmail.com</p>
            </div>
          </div>
          ...
          <div class="flex">
            ...
            <div class="ml-4">
              ...
              <p class="text-sm mt-4 text-black">123 Street 256 House</p>
            </div>
          </div>
          ...
          <div class="flex">
            ...
            <div class="ml-4">
              ...
              <p class="text-xs mt-1 text-black">Monday to Friday.</p>
              <p class="text-sm mt-4 text-black">+158 996 888</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-gray-800 rounded-3xl md:col-span-2 p-8">
        ...
        <p class="text-sm text-gray-400 mt-2 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project and provide help.</p>

        <form>
          <div class="space-y-4 mt-8">
            <input type="text" placeholder="Full Name"
              class="px-2 py-3 bg-transparent text-gray-200 font-medium w-full text-sm border-b border-gray-400 focus:border-yellow-300 outline-none" id="name" name="name" />

            <input type="email" placeholder="Email"
              class="px-2 py-3 bg-transparent text-gray-200 font-medium w-full text-sm border-b border-gray-400 focus:border-yellow-300 outline-none" id="email" name="email" />

            <textarea placeholder="Write Message"
              class="px-2 pt-3 bg-transparent text-gray-200 font-medium w-full text-sm border-b border-gray-400 focus:border-yellow-300 outline-none" id="message" name="message"></textarea>
          </div>
