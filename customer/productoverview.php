...
<div class="font-sans bg-white">
  <div class="p-4 lg:max-w-7xl max-w-4xl mx-auto">
    <div class="grid items-start grid-cols-1 lg:grid-cols-5 gap-12 shadow-[0_2px_10px_-3px_rgba(169,170,172,0.8)] p-6 rounded">
        <div class="lg:col-span-3 w-full lg:sticky top-0 text-center">
          <div class="px-4 py-10 rounded shadow-md relative">
            <img src="../img/<?=$productbyID['img_url']?>" alt="Product" class="w-4/5 aspect-[251/171] rounded object-cover mx-auto" />
    ...
    <div class="mt-12 shadow-[0_2px_10px_-3px_rgba(169,170,172,0.8)] p-6">
      ...
      <div>
      <?php
        $details = nl2br($productbyID['details']); // Convert newlines to <br>
        $details = str_replace("Specification", "<span style='color: black; font-weight: bold;'>Specification</span>", $details); // Change 'Specification' to blue and bold
        $details = str_replace("RESPONSIVENESS", "<span style='color: black; font-weight: bold;'>RESPONSIVENESS</span>", $details); // Change 'Responsiveness' to red and bold
        ?>
