        ...
        <div class="p-6 bg-white shadow-[0_0px_4px_0px_rgba(6,81,237,0.2)] rounded-md relative">
          <div class="flex items-center max-sm:flex-col gap-4 max-sm:gap-6">
            ...
            <div class="sm:border-l sm:pl-4 sm:border-gray-300 w-full">
              ...
              <form action="controlcart.php" method="POST">
              <div class="flex items-center justify-between flex-wrap gap-4">
                <div class="flex items-center gap-3">
                  <h4 class="text-sm font-bold text-black">Qty:</h4>
                  <button
                    name="decrease"
                  ...
                  <span class="font-bold text-sm leading-[16px] text-black"><?=$cart['qty'] ?></span>
                  <button
                    name="increase"
                    class="flex items-center justify-center w-5 h-5 bg-blue-600 outline-none rounded-full">
                ...
                <div class="flex items-center">
                  <h4 class="text-lg font-bold text-black">$<?=$price?></h4>
                  <button class="" name="remove">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-3 shrink-0 fill-gray-400 hover:fill-red-500 absolute top-3.5 right-3.5" viewBox="0 0 320.591 320.591">
